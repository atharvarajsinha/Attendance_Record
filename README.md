...
The backend stores uploaded images under school-code/class/section-aware media folders such as `media/students/<school_code>/<class>/<section>/` and `media/attendance/<school_code>/<class>/<section>/`. The AI service stores embeddings under matching scoped folders such as `media/embeddings/<school_code>/<class>/<section>/student_101.npy`.
